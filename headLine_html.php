    ...
    <body>
		...
		<div id="scroller_super_headerContent">
			<div id="topBox">
				...
				<div id="ScrollerSubHeader" class = "y"><b>wk‡ivbvg</b></div>
			</div>
			<?php
			$oldfile = fopen("headline.txt", "r") or die("Unable to open file!");
			//ob_start();
			...
			$oldfile = fopen("headline.txt", "w") or die("Unable to open file!");
