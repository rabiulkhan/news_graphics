  ...
  <header>
    ...
    <div class="site-title">
      <div class="container">
		...
		<center><a href = "news_graphics_menu.php" background="Black"><mark><h3>Home</h3></mark></a></center>
      </div>
    </div><!-- /.site-title -->
    ...
    <div class="container">
      ...
      <div class="settings">
        ...
        <div class="row">
		  ...
		  <div class="switch">
			<!--<input type="submit" class="button button_size" name="next" value="Next" style = "font : 4"/>--> 
			<button class = "button_size" onclick="headline_next()"><font size = "4">NEXT</font></button>
		  </div>
        </div><!-- /row -->
		...
		<div class="row">
          ...
          <div class="switch">
            <!--<input id="cmn-toggle-5" class="cmn-toggle cmn-toggle-yes-no" type="checkbox">
            <label for="cmn-toggle-5" data-on="ON AIR" data-off="OFF"></label>-->
          <button class = "button_size" onclick="running_program_on()"><font size = "4">ON AIR</font></button>
          </div>
		  <div class="switch">
			<button class = "button_size" onclick="running_program_off()"><font size = "4">OFF</font></button>
		  </div>
        </div>
...
function headline_next() {
		window.location.assign("headline_next.php")
...
function running_program_on() {
	
		window.location.assign("running_program_on.php")
	   
}
function running_program_off(){
	window.location.assign("running_program_off.php")
}
