...
<html>
    ...
    <body>
		<?php
			$oldfile = fopen("current_news.txt", "r") or die("Unable to open file!");
			//ob_start();
		...
		<div id="scroller" class="y">
            <img src="image\News-Headline-Band.png">
		...
		<?php 
			...
			//$newfile = fopen("newfile.txt", "w") or die("Unable to open file!");
			$oldfile = fopen("current_news.txt", "w") or die("Unable to open file!");
